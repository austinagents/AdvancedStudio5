...
const handleRequestElementInstall = async ({ liveEventsServer, request, response, }) => {
    ...
    try {
        ...
        const parsed = (0, studio_shared_1.parseElementDragData)(JSON.stringify({
...
const handleFallback = async ({ remotionRoot, hash, response, request, getCurrentInputProps, getEnvVariables, publicDir, getRenderQueue, getRenderDefaults, numberOfAudioTags, audioLatencyHint, previewSampleRate, gitSource, logLevel, enableCrossSiteIsolation, getStudioRuntimeConfig, }) => {
    var _a;
