...
import { $i as OrthographicCamera, Bs as Vector2, Eo as SRGBColorSpace, Oo as Scene, Vr as LinearSRGBColorSpace, Vs as Vector3, c as three_module_exports, ct as Color, do as Raycaster, o as WebGLRenderer, ra as PerspectiveCamera, st as Clock, ut as ColorManagement, vr as Layers } from "./three.module-omPc_b5b.js";
						...
						if (popHydrationState(workInProgress)) {
							...
							if (null !== returnFiber) switch (returnFiber.tag) {
								case 3:
									...
									break;
								case 27:
								case 5: newProps = returnFiber.memoizedProps, nextResource && (nextResource = diffHydratedTextForDevWarnings(current, renderLanes, newProps), null !== nextResource && (buildHydrationDiffNode(workInProgress, 0).serverProps = nextResource));
							}
...
//#endregion
//#region node_modules/@react-three/fiber/dist/events-cf57b220.esm.js
...
function createReconciler(config) {
	const reconciler = (0, import_react_reconciler.default)(config);
...
function createRoot(canvas) {
	...
	const fiber = prevFiber || reconciler.createContainer(store, 1, null, false, null, "", logRecoverableError, logRecoverableError, logRecoverableError, null);
