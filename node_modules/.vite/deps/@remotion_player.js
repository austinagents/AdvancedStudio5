...
import { Composition, Internals, interpolate, random } from "./remotion.js";
...
var updateAllElementsSizes = () => {
	for (const listener of elementSizeHooks) listener();
};
...
var DefaultPlayPauseButton = ({ playing, buffering }) => {
	...
	if (playing) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PauseIcon, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlayIcon, {});
};
var KNOB_SIZE = 12;
var BAR_HEIGHT = 5;
...
var getFrameFromX = (clientX, durationInFrames, width) => {
	return Math.round(interpolate(clientX, [0, width], [0, durationInFrames - 1], {
...
var reactVersion = "19.2.3".split(".")[0];
...
var reactVersion2 = "19.2.3".split(".")[0];
...
var Thumbnail = (0, import_react.forwardRef)(ThumbnailFn);
var PlayerInternals = {
