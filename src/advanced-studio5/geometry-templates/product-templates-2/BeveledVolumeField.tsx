...
export type BeveledVolumeGeometryProps =
  PT2LoadedProduct & {
    timing:
      ReturnType<
        typeof getPT2Timing
...
export const BeveledVolumeGeometry:
  React.FC<
    BeveledVolumeGeometryProps
  > = ({
    texture,
    image,
    product,
  ...
  React.FC<Props> = ({
    ...
    return (
      ...
      >
        <OffthreadVideo
          src={staticFile(
            "advanced-studio5/product-templates-2/template-57-background.mp4",
          )}
          muted
          style={{
            position: "absolute",
